...

{
    ...
    "duration" : "2023-06-01T02:34:56.123+05:30" ,
    "rating" : 8.9,
    "language" : "English" ,
    "type" : "Action"
}
...
insert into city ( zipcode, cityname , state ) values ( 425412 , "Chennai" , "Tamilnadu"  );
insert into city ( zipcode, cityname , state ) values ( 422003 , "Pune" , "Maharashtra"  );
insert into city ( zipcode, cityname , state ) values ( 556644 , "Bangalore" , "Karnataka"  );

insert into city ( zipcode, cityname , state ) values ( 136118, "Mumbai" , "Maharashtra"  );
insert into city ( zipcode, cityname , state ) values ( 530068 , "Trupati" , "Andhra"  );
insert into city ( zipcode, cityname , state ) values ( 11096, "Kochin , " Kerala "  );
